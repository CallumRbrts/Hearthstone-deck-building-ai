...
\begin{subfigure}{.3\textwidth}
  ...
  \caption{All Cards}
\end{subfigure}
\caption{Neutral of real, generated deck and overall}
\end{figure}
\subsection{Test 2 - Warlock Deck}
\begin{figure}[H]
\centering
...
-- Aggro decks provide better results because they require playing as many cards as possible whereas more control decks require ressource management--
%----------------------------------------------------------------------------------------
%	BIBLIOGRAPHY
%---------------------
\bibliography{export}
